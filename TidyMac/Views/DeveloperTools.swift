                ...
                ScrollView {
                    VStack(alignment: .leading, spacing: DesignSystem.Spacing.medium) {
                        ForEach(descriptors(for: viewModel.selectedCategory)) { descriptor in
                            StatusCard(
                                title: descriptor.title, iconName: descriptor.icon,
                                accent: descriptor.accentColor(palette: palette)
                            ) {
                                VStack(alignment: .leading, spacing: DesignSystem.Spacing.small) {
                                    ...
                                    HStack {
                                        Button {
                                            ...
                                            Label(
                                                descriptor.buttonTitle,
                                                systemImage: descriptor.buttonIcon)
                                        }
        ...
        case .caches:
            return [
                ...
                OperationDescriptor(
                    ...
                    subtitle:
                        "Clears index, module, and SourceKit caches to fix autocomplete issues.",
                    icon: "icloud.slash",
        ...
        case .simulators:
            return [
                ...
                OperationDescriptor(
                    ...
                    subtitle:
                        "Removes all simulator devices, forcing Xcode to recreate them on next launch.",
                    icon: "trash.slash",
        ...
        case .toolchains:
            return [
                OperationDescriptor(
                    ...
                    subtitle:
                        "Deletes log output generated by custom toolchains and swift build diagnostics.",
...
extension DeveloperTools {
    fileprivate var overlayCard: some View {
        ZStack {
                ...
                .overlay {
                    VStack(spacing: DesignSystem.Spacing.large) {
                        ...
                        VStack(spacing: DesignSystem.Spacing.small) {
                            ...
                            Text(
                                "We’re applying your developer action. This usually finishes in a moment."
                            )
                            .font(DesignSystem.Typography.caption)
                            .foregroundColor(palette.secondaryText)
...
private struct OperationDescriptor: Identifiable {
    ...
    var buttonStyle: some ButtonStyle {
        tone == .safe
            ? AnyButtonStyle(PrimaryActionButtonStyle()) : AnyButtonStyle(DestructiveButtonStyle())
    }
}
