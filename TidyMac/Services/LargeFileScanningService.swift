...
final class FileSystemLargeFileScanningService: LargeFileScanningService {
    ...
    init(
        ...
        self.candidateDirectories =
            ...
            ?? FileSystemLargeFileScanningService.defaultCandidateDirectories(
            ...
            DispatchQueue.global(qos: .userInitiated).async {
                ...
                for directory in directories {
                    ...
                    for fileURL in localURLs {
                        do {
                            ...
                            if permissionMessage == nil {
                                permissionMessage =
                                    "TidyMac needs permission to inspect \(parentPath)."
                            }
                        }
                        ...
                        progress(
                            LargeFileScanProgress(
                                totalFiles: totalCount, scannedFiles: processedCount))
                ...
                if permissionIssue, !permissionPaths.isEmpty {
                    Diagnostics.warning(
                        ...
                        metadata: [
                            "paths": permissionPaths.sorted().prefix(3).joined(separator: ", ")
                        ]
                    )
                }
                ...
                Diagnostics.info(
                    ...
                    metadata: [
                        "totalFiles": "\(totalCount)", "results": "\(aggregatedFiles.count)",
                    ]
                )

                continuation.resume(
                    returning: LargeFileScanResult(
    ...
    func delete(paths: [String]) throws {
        ...
        if !privilegedTargets.isEmpty {
            ...
            case .failure(let message):
                ...
                throw NSError(
                    domain: "com.tidymac.largefiles", code: 3,
        ...
        if !failures.isEmpty {
            ...
            throw NSError(
                domain: "com.tidymac.largefiles", code: 4,
                userInfo: [NSLocalizedDescriptionKey: "Unable to delete \(failures.count) file(s)."]
            )
        }
