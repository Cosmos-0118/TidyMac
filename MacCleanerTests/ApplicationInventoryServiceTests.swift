...
final class ApplicationInventoryServiceTests: XCTestCase {
    func testUninstallRespectsExclusionList() async {
        let application = Application(name: "DemoApp", bundleID: "com.maccleaner.demo", bundlePath: "/Applications/Demo.app")
    ...
    func testUninstallEscalatesPrivilegesOnPermissionError() async throws {
        ...
        try await service.uninstall(application: Application(name: "NeedsAdmin", bundleID: "com.maccleaner.demo", bundlePath: fileURL.path))
